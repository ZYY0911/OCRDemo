...
public class MainActivity extends AppCompatActivity {
    ...
    private void initAccessTokenWithAkSk() {
        OCR.getInstance(this).initAccessTokenWithAkSk(new OnResultListener<AccessToken>() {
            ...
            public void onError(OCRError error) {
                error.printStackTrace();
                Log.e("aaa", "onError:getLogId "+error.getLogId());
                Log.e("aaa", "onError:getCause "+error.getCause());
                Log.e("aaa", "onError:getErrorCode "+error.getErrorCode());
                alertText("AK，SK方式获取token失败", error.getMessage());
            }
        }, getApplicationContext(),  "IC5GlRiNIv5n5Z9tUwHXe56e", "p3jlQPbcU9F9Quef544v3t5e4PLM3E1M");
    }
